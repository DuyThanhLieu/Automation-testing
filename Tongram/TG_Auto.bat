...
call npx playwright test  TG_Languages.spec.js TG_Contact.spec.js --reporter=html --output=./Results --workers=1 
@REM call npx playwright test TG_DailyTask.spec.js TG_VerifyPoint.spec.js TG_Actions.spec.js TG_Languages.spec.js --reporter=html --output=./Results --workers=1 
