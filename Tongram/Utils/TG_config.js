...
export const config = {
  ...
  telegramAuthUrl:
    "https://oauth.telegram.org/auth?bot_id=7241997507&origin=https%3A%2F%2Ftongram.app&request_access=true&return_to=https%3A%2F%2Ftongram.app%2Fen",

  //ACCOUNT
  phoneNumber: "343602871",
  cookiesDir: "./Cookies",
  ...
  Earn_DailyLogin:
    "//div[contains(@class, 'flex flex-row items-center justify-between rounded-[20px]')]",

  Stars_5:
    "body > main > section.mt-8.flex.flex-col.gap-y-6.pt-6 > div.flex.flex-col.gap-y-4 > div:nth-child(1) > div > div > div > svg:nth-child(5)",
